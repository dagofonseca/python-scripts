...
search_box.clear()
search_box.send_keys("DF2")
time.sleep(2)  # Pausa para que se cargue la búsqueda

contacto = driver.find_element(By.XPATH, f"//span[@title='DF2']")
contacto.click()
...
with open('C:/Users/dago/Documents/ChatWhatsApp/prueba.txt', 'r', encoding='utf-8') as file:
